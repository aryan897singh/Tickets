...
public class EventRepository {
    private final List<Event> events = List.of(
            new Event (501, "Globomantics Tech Conference",
                    new Organizer (101, "Globomantics", "Globomantics Technology Corporation"), new Venue (201, "Globomatics Main Office", "Test Street 325", "New York", "USA"),
            ...
            new Event (502, "Globomantics Developer Day",
                    ...
                    new Venue (201, "Globomatics Main Office", "Test Street 325", "New York", "USA"), LocalDate.of (2024, 1, 10), LocalDate.of (2024, 1, 10)),
